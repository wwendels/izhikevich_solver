# python module for analysis 2D ODE systems
...
def phasePlaneAnalysis(modelclass,label,xmesh,ymesh,tmesh,X0,t=0,plot_traj=1,eqtol=1e-3,opt_plot=1,legend=True,title="",x1lims=[],x2lims=[],plotI="",savepath=""):
    ...
    if opt_plot == 1:
        ...
        savename = savepath+label+".png" #analysis.png
...
def phasePlaneAnalysis2(modelclass,xmesh,ymesh,t=0,Xtraj=np.array([]),T=np.array([]),plot_traj=1,label="",eqtol=1e-3,opt_plot=2,legend=True,title="",x1lims=[],x2lims=[],tlims=[],plotI="",savepath=""): #ncmethod=1
